...
const MonthlyStats = ({ monthLabel, totalHours, daysWorked, averageHours }) => {
  return (
    <div className="bg-white md:p-6 rounded-lg md:shadow-sm ">
      ...
      <p className="text-gray-600 text-sm mb-6">{monthLabel}</p>
      ...
      <div className="bg-linear-to-br from-orange-400 to-orange-600 text-white p-6 rounded-lg mb-6">
        ...
        <div className="flex items-end justify-between">
          <div>
            <p className="text-5xl font-bold">{totalHours.toFixed(1)}</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-3xl font-bold text-gray-900">{averageHours.toFixed(1)}</p>
        </div>
      </div>
    </div>
  );
